                              ...
                              onPressed: () async {
                                ...
                                if (_globalkey.currentState!.validate()) {
                                  ...
                                  if(response.statusCode == 200){
                                    finalResponse = response.body;
                                    print('startValue');
                                    print(finalResponse.toString().characters.characterAt(1));
                                    print(finalResponse.toString().characters.characterAt(1) != 'I');
                                    if(finalResponse.toString().characters.characterAt(1) == 'I' /*||finalResponse.toString().characters.characterAt(1) != '{'*/){
                                      print('helloworld');
                                      te = false;
                                      Fluttertoast.showToast(msg: finalResponse,toastLength: Toast.LENGTH_LONG, backgroundColor: Colors.red,gravity: ToastGravity.BOTTOM,);
                                    }
